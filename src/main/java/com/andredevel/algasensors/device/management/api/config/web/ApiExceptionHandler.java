package com.andredevel.algasensors.device.management.api.config.web;

import com.andredevel.algasensors.device.management.api.client.SensorMonitoringClientBadGatewayException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handle(SensorMonitoringClientBadGatewayException e) {
        ...
        problemDetail.setDetail(e.getMessage());
        problemDetail.setType(URI.create("/erros/bad-gatway"));
